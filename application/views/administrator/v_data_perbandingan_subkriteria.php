                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                ...
                                <a href="<?php echo base_url();?>index.php/c_perbandingan_subkriteria/edit_perbandingan_subkriteria/<?php echo "$id";?>" class="btn btn-warning btn-sm col-sm-1" style="float: right; margin-bottom: 5px;"><span class="glyphicon glyphicon-edit"></span> Update</a>
                                ...
                                <div class="x_content" style="margin-top: 20px;">
                                    ...
                                    <tr>
                                        ...
                                        <th><h5>
                                            <?php echo $subkriteria->subkriteria;?></h5></th>
                                            <?php } ?>
                                ...
                                <?php } else { ?>
                                    ...
                                    <tr>
                                        <th></th>
                                        <?php foreach ($daftar_subkriteria as $subkriteria) {?>
                                        <th colspan="3"><h5><?php echo $subkriteria->subkriteria;?></h5></th>
                                    <?php } ?>
                                ...
                                <hr />
                                    ...
                                    <tr>
                                        ...
                                        foreach ($daftar_subkriteria as $subkriteria2) {
                                            if($subkriteria2->id_subkriteria == $subkriteria->id_subkriteria){?>
