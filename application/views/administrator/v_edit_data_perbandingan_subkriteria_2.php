            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="clearfix"></div>
                        ...
                        <div class="x_content">
                        <form action="<?php echo base_url();?>index.php/c_perbandingan_subkriteria_2/update_perbandingan_subkriteria/<?php echo "$id";?>" method="POST">
                        <table class="table table-striped table-hover table-bordered">
                            <tr>
                            <th></th>
                            <?php foreach ($daftar_subkriteria as $subkriteria) {?>
                            <th><h5><?php echo $subkriteria->subkriteria_2;?></h5></th>
                            <?php } ?>
                            </tr>        
                            <?php $kolom = 1;
                        ...
                        <a href="<?php echo base_url();?>index.php/c_perbandingan_subkriteria_2/perbandingan_subkriteria/<?php echo "$id";?>" class="btn btn-danger btn-sm col-sm-1" style="float: right; margin-bottom: 5px;"><span class="glyphicon glyphicon-remove-sign"></span> Batal</a>
